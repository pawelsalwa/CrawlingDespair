...
namespace Pawn
{
	...
	public class PawnMovementBase
	{
		...
		public PawnMovementBase(CharacterController characterController, MovementSetup movementSetupBase)
		{
			this.characterController = characterController;
			this.movementSetupBase = movementSetupBase;
			this.pawnTurning = new PawnTurning(characterController.transform, movementSetupBase);
		}
