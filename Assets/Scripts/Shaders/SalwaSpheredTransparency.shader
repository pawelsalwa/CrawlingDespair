Shader "Unlit/SalwaSpheredTransparency"
{
    Properties
    {
		...
		_radius("radius", Range(0.0,30.0)) = 2.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                float isInsideSphere : TEXCOORD3;
                UNITY_FOG_COORDS(1)
            ...
            v2f vert (appdata v)
            {
                ...
                float distFromSphereCenter = length(_sphereCenter - o.worldPos);
                distFromSphereCenter = abs(distFromSphereCenter);
                
                if (distFromSphereCenter > _radius) {              
                    o.isInsideSphere = 1.0;
                } else {
                    o.isInsideSphere = 0.0;
                }
